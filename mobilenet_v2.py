...
# MobileNet2 Model
model2=keras.applications.mobilenet_v2.MobileNetV2(input_shape=input_shape, alpha=1.0, weights=None, input_tensor=None, pooling=None, classes=340)
